                    ...
                    <div className="mx-auto max-w-7xl px-4 py-6 space-y-6">
                        {Array.from({ length: 4 }).map((_, i) => (
                            <div key={i} className="rounded-xl border border-[#1E3A2A] bg-[#162B20] p-6">
                                <div className="h-6 w-40 animate-pulse rounded bg-[#1E3A2A]" />
                                <div className="mt-3 h-3 w-64 animate-pulse rounded bg-[#1E3A2A]" />
                                <div className="mt-4 h-2 w-full animate-pulse rounded-full bg-[#1E3A2A]" />
                            </div>
                        ))}
                    </div>
                </main>
